...
router.post("/", userController.rejectDuplicateUsername, userController.createUser);
router.put("/:user_id", userController.rejectDuplicateUsername, userController.updateUserById);
